...
namespace homework01
{
    ...
    sealed partial class App : Application
    {
        ...
        public TodoItemViewModel ViewModels;
        public App()
        {
            this.InitializeComponent();
            this.Suspending += OnSuspending;
            ViewModels = new TodoItemViewModel();
        }
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                ///这里
                //Windows.UI.Core.SystemNavigationManager.GetForCurrentView().BackRequested += BackRequested.OnBackgroundActivated;
